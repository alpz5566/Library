...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/css/jquery-treetable/jquery.treetable.css">
    <link rel="stylesheet" href="${ctx}/css/jquery-treetable/jquery.treetable.theme.default.css">
    <style>
        #table th, #table td {
            font-size: 14px;
            padding : 8px;
...
<body>
			...
			<table id="table">
			    ...
			    <tbody>
			        <c:forEach items="${permissionList}" var="permission">
			            <tr data-tt-id='${permission.id}' <c:if test="${not permission.rootNode}">data-tt-parent-id='${permission.parentid}'</c:if>>
			                ...
			                <td>
			                    ...
			                    <c:if test="${not permission.rootNode}">
				                    <%-- <shiro:hasPermission name="permission:delete"> --%>
				                        <a class="deleteBtn" href="#" data-id="${permission.id}">删除</a>
				                    <%-- </shiro:hasPermission> --%>
			                    </c:if>
			                </td>
			            </tr>
    ...
    <!-- jquery treetable -->
    <script src="${ctx}/js/jquery.treetable.js"></script>
