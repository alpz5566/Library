...
<body>
    ...
    <script src="${ctx}/sbadmin/sb-admin/bower_components/raphael/raphael-min.js"></script>
    <script src="${ctx}/sbadmin/sb-admin/bower_components/morrisjs/morris.min.js"></script>
    <script src="${ctx}/sbadmin/sb-admin/js/morris-data.js"></script>
